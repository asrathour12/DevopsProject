...
```
cd existing_repo
git remote add origin https://gitlab.com/cliff-public/assignment_app.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/cliff-public/assignment_app/-/settings/integrations)
